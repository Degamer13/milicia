...
$extraer= $ejecute->fetch_assoc(); 
    ...
    <form id="regForm" action="../php/actualiza_militar.php?id_m=<?=$extraer['id_m']?>" enctype="multipart/form-data" method="POST" class=" card bg bg-light" >
...
">MEDIDA DISCIPLINARIA
  ...
  <option value="<?php echo $extraer['talla'] ?>"><?php echo $extraer['talla'] ?></option>
    ...
    <p><input type="ano_ultasce" oninput="this.className = ''" name="ano_ultasce" value="<?php echo $extraer['ano_ultasce'] ?>"></p>
