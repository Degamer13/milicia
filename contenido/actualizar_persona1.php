...
<script src="../js/all.min.js" crossorigin="anonymous"></script>
    ...
    <form id="regForm" action="../php/actualiza_persona1.php?id_p=<?=$extraer['id_p']?>" enctype="multipart/form-data" method="POST" class=" card bg bg-light" >
...
document.getElementById("FechaActual").value = fecha.toJSON().slice(0,10);</script>
  ...
  <div class="tab">
    ...
    <p><input  placeholder="" oninput="this.className = ''" onkeyup="this.value=this.value.toUpperCase();" type="email" value="<?php echo $extraer['correo'] ?>" id="email" name="correo"><span id="email-validation-message"></span></p>
