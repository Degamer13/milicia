...
while($fila = mysqli_fetch_array($result)){
    ...
    echo "<td><a  href='vista_persona1.php?id_p=". $fila['id_p']. "' class='btn btn-primary btn-raised btn-xs'><i class='bi-eye-fill'></i></a></td>";

      echo "<td><a  href='actualizar_persona1.php?id_p=". $fila['id_p']. "' class='btn btn-success btn-raised btn-xs'><i class='bi-pencil-fill'></i></a></td>";
