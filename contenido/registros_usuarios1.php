...
$queto= "SELECT * FROM usuarios u LEFT JOIN cargos c ON u.cargo=c.id_c WHERE u.cargo=c.id_c AND u.cargo != '1'";
...
while($fila = mysqli_fetch_array($result)){
    ...
    echo "<td>". $fila['fecha']. "</td>";
      ...
      echo "<td><a href='actualizar_usuario1.php?id=".$fila['id']."' class='btn btn-primary btn-raised btn-xs'><i class='bi-pencil-fill'></i></a></td>";
