...
$cargo=4;
$cargo1=3;
$consulta = "SELECT * FROM usuarios WHERE id = '$id' OR $cargo='cargo' OR $cargo1='cargo'";
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark"  id="sidenavAccordion">
                    ...
                    <div class="sb-sidenav-footer">
                        <div class="h6" style="text-transform: uppercase" >Administrador: <b><?php echo $row['usuario'] ?></b></div>
