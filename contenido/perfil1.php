...
$consulta = "SELECT * FROM usuarios u LEFT JOIN cargos c ON u.cargo=c.id_c LEFT JOIN preguntas p ON p.id_user=u.id WHERE id='$id' OR $cargo='cargo' OR $cargo1='cargo'";
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark"  style="background-color: #2F4F4F;">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <li><a class="dropdown-item" href="perfil1.php" >Perfil</a></li>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark"  id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="registrar_persona1.php"><i class="bi bi-person-plus-fill"></i>Persona</a>
                                    <a class="nav-link" href="registro_familiar1.php"><i class="bi bi-people-fill"></i>Familiar</a>
                                    <a class="nav-link" href="registro_militar1.php"><i class="bi bi-person-fill"></i>Militar</a>
                                    <a class="nav-link" href="registro_salud.php"><i class="bi bi-clipboard-plus-fill"></i>Salud y Otros</a>
                                    <a class="nav-link" href="registro_cursos.php"><i class="bi bi-journals"></i>Cursos</a>
                                    <a class="nav-link" href="registro_tarea.php"><i class="bi bi-journal-bookmark-fill"></i>Asignación de Tarea</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayoutss" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="usuario1.php"><i class="bi-person-plus-fill"></i> Nuevo Usuario</a>
                                    <a class="nav-link" href="registros_usuarios1.php"><i class="bi-table"></i>Lista Usuarios</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayoutst" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="registros_militares1.php"><i class="bi-table"></i>Listados Militares</a>
                                    <a class="nav-link" href="estadisticas1.php"><i class="bi-graph-up"></i>Estadisticas</a>
                                </nav>
                            </div>
                            <div class="sb-sidenav-menu-heading">Reportes</div>
                            <a class="nav-link" href="generar_pdf1.php">
                                <div class="sb-nav-link-icon"></div>
                    ...
                    <div class="sb-sidenav-footer">
                        <div class="h6" style="text-transform: uppercase" >Administrador: <b><?php echo $extraer['usuario'] ?></b></div>
...
?>" name="correo" required>
  ...
  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"><div class="row">
    ...
    <div class="col-md-6 order-md-1 bg-light">
      ...
      <form class="needs-validation" method="POST" action="../php/pregunta1.php" novalidate>
  ...
  <div class="row">
    ...
    <h4 class="mb-3">Editar Usuario</h4>
      ...
      <form class="needs-validation" method="POST" onsubmit="return validarContraseña()" action="../php/actualizar_perfil1.php?id=<?=$extraer['id']?>" novalidate>
...
?>" required>
  ...
  <div class="tab-pane fade" id="pollo" role="tabpanel" aria-labelledby="pollo-tab"><div class="row">
    ...
    <div class="col-md-6 order-md-1 bg-light">
      ...
      <form class="needs-validation" method="POST" action="../php/actualizar_preguntas1.php?id_r=<?=$extraer['id_r']?>" novalidate>
