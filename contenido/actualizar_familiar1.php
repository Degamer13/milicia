...
while($fila = mysqli_fetch_array($result)){
    ...
    echo "<td><a  href='dato_familia1.php?id_f=". $fila['id_f']. "' class='btn btn-success btn-raised btn-xs'><i class='bi-pencil-fill'></i></a></td>";
    echo "<td><a  class='btn btn-danger btn-raised btn-xs' href='../php/eliminar_familiar1.php?id_f=". $fila['id_f'] ."'>
