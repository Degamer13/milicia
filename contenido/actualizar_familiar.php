...
<html lang="es">
    <head>
        ...
        <title>Actualizar Familiares</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                            <center>
                            <a  href="registros_militares.php"><i class="bi bi-box-arrow-left"></i>Salir de Vista Familiar</a> 
...
while($fila = mysqli_fetch_array($result)){
    ...
    echo "<td><a  href='dato_familia.php?id_f=". $fila['id_f']. "' class='btn btn-success btn-raised btn-xs'><i class='bi-pencil-fill'></i></a></td>";
    echo "<td><a  class='btn btn-danger btn-raised btn-xs' href='../php/eliminar_familiar.php?id_f=". $fila['id_f'] ."'>
    <i class='bi-trash3-fill'></i></td>";
