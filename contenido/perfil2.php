...
$id = $_SESSION["id"];
$cargo=4;
$consulta = "SELECT * FROM usuarios u LEFT JOIN cargos c ON u.cargo=c.id_c LEFT JOIN preguntas p ON p.id_user=u.id WHERE id='$id' OR $cargo='cargo'";
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark"  id="sidenavAccordion">
                    ...
                    <div class="sb-sidenav-footer">
                        <div class="h6" style="text-transform: uppercase" >Usuario General: <b><?php echo $extraer['usuario'] ?></b></div>
...
?>" name="correo" required>
  ...
  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"><div class="row">
    ...
    <div class="col-md-6 order-md-1 bg-light">
      ...
      <form class="needs-validation" method="POST" action="../php/pregunta2.php" novalidate>
  ...
  <div class="row">
    ...
    <h4 class="mb-3">Editar Usuario</h4>
      ...
      <form class="needs-validation" method="POST" onsubmit="return validarContraseña()" action="../php/actualizar_perfil2.php?id=<?=$extraer['id']?>" novalidate>
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input type="text"  class="form-control" id="usuario" value="<?php echo $extraer['usuario'] ?>"   name="usuario" maxlength="15"  required >
            <div class="invalid-feedback" >
            Campo Requerido.
            </div>
          </div>
        ...
        <div class="mb-3">
         ...
         <input type="hidden"  class="form-control" id="cargo" value="<?php echo $extraer['cargo'] ?>"  name="cargo" required>
...
?>" required>
  ...
  <div class="tab-pane fade" id="pollo" role="tabpanel" aria-labelledby="pollo-tab"><div class="row">
    ...
    <div class="col-md-6 order-md-1 bg-light">
      ...
      <form class="needs-validation" method="POST" action="../php/actualizar_preguntas2.php?id_r=<?=$extraer['id_r']?>" novalidate>
