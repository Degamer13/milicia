...
<body>
<center><h3>LISTADO POR GENERO MASCULINO</h3></center>
                                ...
                                <table class="table text-center">
                                   ...
                                   <img src="" alt="">
                                        ...
                                        <?php
                      require"../php/conexion.php";
                                        $queto= "SELECT * FROM persona p  LEFT JOIN datos_militar d  ON d.id_mili=p.id_p LEFT JOIN adi_datos a ON d.adi=a.id_a LEFT JOIN region_tabla r ON a.id_adi=r.id_b LEFT JOIN zodi_tabla z ON r.id_region=z.id_c WHERE genero='HOMBRE'";
