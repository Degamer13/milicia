...
$cargo1=3;
$cargo2=2;
$consulta = "SELECT * FROM usuarios WHERE id = '$id' OR $cargo='cargo' OR $cargo1='cargo' OR $cargo2='cargo'";
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark"  id="sidenavAccordion">
                    ...
                    <div class="sb-sidenav-footer">
                        <div class="h6" style="text-transform: uppercase" >Super Usuario: <b><?php echo $row['usuario'] ?></b></div>
