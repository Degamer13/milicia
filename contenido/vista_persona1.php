...
<script src="../js/all.min.js" crossorigin="anonymous"></script>
       ...
       <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                       ...
                       <center>
                       <a  href="vista_persona.php1?id_p=<?=$extraer['id_p']?>"><i class="bi bi-person-plus-fill"></i>Persona</a> 
    ...
    <form id="regForm" action="registros_militares1.php" enctype="multipart/form-data" method="" class=" card bg bg-light" >
